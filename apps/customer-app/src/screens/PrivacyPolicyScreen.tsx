...
import {
  ...
  TouchableOpacity, Animated, Linking, Image,
} from 'react-native';
...
const SECTIONS = [
  {
    icon: 'https://img.icons8.com/color/96/company.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/smartphone--v1.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/scales--v1.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/handshake--v1.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/globe--v1.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/time--v1.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/user--v1.png',
    title: '9. Your Rights',
  ...
  {
    icon: 'https://img.icons8.com/color/96/cookie.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/do-not-disturb.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/external-link--v1.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/megaphone--v1.png',
  ...
  {
    icon: 'https://img.icons8.com/color/96/synchronize--v1.png',
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView style={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          <Image source={{ uri: 'https://img.icons8.com/color/96/privacy--v1.png' }} style={styles.heroImg} resizeMode="contain" />
          ...
          {SECTIONS.map((section, idx) => (
            <View key={idx} style={styles.sectionCard}>
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Image source={{ uri: section.icon }} style={styles.sectionIconImg} resizeMode="contain" />
...
const styles = StyleSheet.create({
  ...
  sectionIconImg: { width: 20, height: 20, marginRight: 10 },
  sectionTitle: {
    fontSize: 13,
    fontWeight: '700',
